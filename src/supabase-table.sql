...
from
 ...
 create table public.cp_rankings_current (
  ...
  collected_at timestamp with time zone not null,
  updated_at timestamp with time zone null default CURRENT_TIMESTAMP,
  category3 character varying(255) null,
  category4 character varying(255) null,
  seller_name character varying(255) null,
  delivery_type character varying(255) null,
  is_rocket boolean null default false,
  is_rocket_fresh boolean null default false,
  is_rocket_global boolean null default false,
  rating numeric(3, 2) null,
  review_count integer null default 0,
  is_wow_deal boolean null default false,
  discount_rate numeric(5, 2) null,
  original_price integer null,
  card_discount integer null,
  hprice integer null,
